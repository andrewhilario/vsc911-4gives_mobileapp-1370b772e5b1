...
export const SignUpDocumentsMainContainer = styled(Container)`
    position: relative;
    flex: 1;
...
export const SignUpDocumentsMainTitleContainer = styled.View`
    width: 92%;
    flex-direction: row;
    align-items: center;
...
export const SignUpDocumentsMainTitleText = styled.Text`
