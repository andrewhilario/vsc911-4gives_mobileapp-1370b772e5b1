...
export const BasicInformationContainer = styled(Container)`
    position: relative;
    flex: 1;
...
export const BasicInformationTitleContainer = styled.View`
    width: 92%;
    flex-direction: row;
    align-items: center;
...
export const BasicInformationTitleText = styled.Text`
